...
public int minx,miny,minz,maxx,maxy,maxz;
	...
	public Vec3d getRandomPosInsideBoundary(){
		double x = MxRand.get().nextInt(this.maxx + 1 - this.minx) + this.minx;
		double y = MxRand.get().nextInt(this.maxy + 1 - this.miny) + this.miny;
		double z = MxRand.get().nextInt(this.maxz + 1 - this.minz) + this.minz;
